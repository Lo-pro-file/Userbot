...
@Client.on_message(command(["kang", "steal"]))
@errors
@sudo_users_only
...
__MODULE__ = "Sᴛɪᴄᴋᴇʀ"
__HELP__ = """
**🥀 Kᴀɴɢ Aɴʏ Sᴛɪᴄᴋᴇʀ Aɴᴅ Mᴀᴋᴇ Yᴏᴜʀ Oᴡɴ Sᴛɪᴄᴋᴇʀ Pᴀᴄᴋ ✨**

**ᴜsᴀɢᴇ:**
`.kang` - **Rᴇᴘʟʏ Tᴏ Sᴛʀɪᴄᴋᴇʀ Tᴏ Kᴀɴɢ Sᴛɪᴄᴋᴇʀ.**

`.packinfo` - **Gᴇᴛ Iɴғᴏʀᴍᴀᴛɪᴏɴ Oғ Yᴏᴜʀ Sᴛɪᴄᴋᴇʀ Pᴀᴄᴋ.**
"""
